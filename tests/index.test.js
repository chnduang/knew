...
describe('knew dist files', () => {
  // https://github.com/ant-design/ant-design/issues/1638
  // https://github.com/ant-design/ant-design/issues/1968
  it('exports modules correctly', () => {
    // eslint-disable-next-line global-require,import/no-unresolved
    const knew = testDist ? require('../dist/knew') : require('../components');
    expect(Object.keys(knew)).toMatchSnapshot();
  });

  // https://github.com/ant-design/ant-design/issues/1970
  // https://github.com/ant-design/ant-design/issues/1804
  if (testDist) {
    it('knew.js should export version', () => {
      // eslint-disable-next-line global-require,import/no-unresolved
      const knew = require('../dist/knew');
      expect(knew).toBeTruthy();
      expect(knew.version).toBe(pkg.version);
    });

    it('knew.min.js should export version', () => {
      // eslint-disable-next-line global-require,import/no-unresolved
      const knew = require('../dist/knew.min');
      expect(knew).toBeTruthy();
      expect(knew.version).toBe(pkg.version);
    });
